...
describe('TokenChecker', function () {
    var _this = this;
    var accounts, tokenChecker, mockERC20, mockERC721, mockERC1155;
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        var TokenChecker, MockERC20, MockERC721, MockERC1155;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, hardhat_1.ethers.getSigners()];
                case 1:
                    accounts = _a.sent();
                    return [4 /*yield*/, hardhat_1.ethers.getContractFactory('TokenChecker')];
                case 2:
                ...
                case 10:
                    mockERC1155 = _a.sent();
                    return [4 /*yield*/, mockERC1155.mint(accounts[0].address, 1, 1000, '0x')];
                case 11:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Should return true if the user has enough ERC20 tokens', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC20Balance(mockERC20.address, accounts[0].address, hardhat_1.ethers.utils.parseEther('1'))];
                    case 1:
                        result = _a.sent();
    ...
    it('Should return false if the user does not have enough ERC20 tokens', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC20Balance(mockERC20.address, accounts[0].address, hardhat_1.ethers.utils.parseEther('2000'))];
                    case 1:
                        result = _a.sent();
    ...
    it('Should return true if the user owns the ERC721 token', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC721Ownership(mockERC721.address, 1, accounts[0].address)];
                    case 1:
                        result = _a.sent();
                        chai_1.expect(result).to.equal(true);
                        return [2 /*return*/];
    ...
    it('Should return true if the user has enough ERC721 tokens', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC721Balance(mockERC721.address, accounts[0].address, 1)];
                    case 1:
                        result = _a.sent();
                        chai_1.expect(result).to.equal(true);
                        return [2 /*return*/];
    ...
    it('Should return true if the user has enough ERC1155 tokens', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC1155Balance(mockERC1155.address, 1, accounts[0].address, 1000)];
                    case 1:
                        result = _a.sent();
                        chai_1.expect(result).to.equal(true);
                        return [2 /*return*/];
    ...
    it('Should return false if the user does not have enough ERC1155 tokens', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC1155Balance(mockERC1155.address, 1, accounts[0].address, 2000)];
                    case 1:
                        result = _a.sent();
                        chai_1.expect(result).to.equal(false);
                        return [2 /*return*/];
