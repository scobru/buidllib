...
describe("Treasury", () => {
    ...
    const setup = async () => {
        ...
        const token = await Token.deploy(signer.address, ethers.utils.parseEther("1000"));
    ...
    it("receives ETH correctly", async () => {
    ...
    it("owner can send ETH correctly", async () => {
    ...
    it("other account can't send ETH", async () => {
