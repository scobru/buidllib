...
describe('TokenChecker', function () {
    ...
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    MockERC20 = _a.sent();
                    return [4 /*yield*/, MockERC20.deploy(accounts[0].address, ethers.utils.parseEther('1000'))];
                case 5:
                    mockERC20 = _a.sent();
    ...
    it('Should return true if the user has enough ERC20 tokens', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC20Balance(mockERC20.address, accounts[0].address, ethers.utils.parseEther('1'))];
                    case 1:
                        result = _a.sent();
    ...
    it('Should return false if the user does not have enough ERC20 tokens', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenChecker.checkERC20Balance(mockERC20.address, accounts[0].address, ethers.utils.parseEther('2000'))];
                    case 1:
                        result = _a.sent();
