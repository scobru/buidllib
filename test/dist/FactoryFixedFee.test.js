...
describe("FactoryFixedFee", function () {
    ...
    var setup = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, hardhat_1.ethers.getContractFactory("MockFactoryFixedFee")];
                case 1:
                    Factory = _b.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Factory.deploy(owner.address, 100)];
                case 4:
                    factory = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = chai_1.expect;
                        return [4 /*yield*/, factory.getCreationFee()];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        factory = (_b.sent()).factory;
                        return [4 /*yield*/, factory.setFixedFee(200)];
                    case 2:
                        _b.sent();
                        _a = chai_1.expect;
                        return [4 /*yield*/, factory.getCreationFee()];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, factory.createContract(owner.address, { value: 100 })];
                    case 2:
                        _b.sent();
    ...
    it("Should revert if creation fee is incorrect", function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, factory, owner;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, setup()];
                    case 1:
